...
#                        admins_logins GET    /admins/logins(.:format)                             admins/logins#index
#     clear_filters_admins_action_step PUT    /admins/action_steps/:id/clear_filters(.:format)     admins/action_steps#clear_filters
#           preview_admins_action_step GET    /admins/action_steps/:id/preview(.:format)           admins/action_steps#preview
...
#              activate_admins_thriver PUT    /admins/thrivers/:id/activate(.:format)              admins/thrivers#activate
#            deactivate_admins_thriver PUT    /admins/thrivers/:id/deactivate(.:format)            admins/thrivers#deactivate
#                       admins_thriver DELETE /admins/thrivers/:id/destroy(.:format)               admins/thrivers#destroy
#        restart_survey_admins_thriver PUT    /admins/thrivers/:id/restart_survey(.:format)        admins/thrivers#restart_survey
# clear_recommendations_admins_thriver PUT    /admins/thrivers/:id/clear_recommendations(.:format) admins/thrivers#clear_recommendations
...
#                                      GET    /admins/thrivers/:id(.:format)                       admins/thrivers#show
...
#                  review_notification GET    /notifications/:id/review(.:format)                  notifications#review
...
#                      plans_show_more GET    /plans/show_more(.:format)                           plans#show_more
#                          get_started GET    /get_started(.:format)                               support#get_started
#                             get_help GET    /get_help(.:format)                                  support#get_help
...
Rails.application.routes.draw do
  ...
  namespace :admins do
    ...
    resources :thrivers do
      member do
        ...
        put 'activate',      to: 'thrivers#activate'
        put 'deactivate',    to: 'thrivers#deactivate'
        put 'resend',        to: 'thrivers#resend'
  ...
  resources :notifications do
    member do
      get 'review',     to: 'notifications#review'
    end
  end
