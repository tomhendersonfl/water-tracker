module Thrive::GlobalConstants
  ...
  NOTIFY_TEXT = "!!! Alert! Information that you have submitted suggests that you may have a medical or behavioral condition warranting attention by a medical provider.
                ...
                This is solely related to your status as a Cancer Survivor and is intended to help maximize your healthy lifestyle and facilitate your goals in connection with the iTHRIVE Plan.
                This Alert is confidential and will not be sent to any health care providers or disclosed to any other individual or entity, UNLESS you are using the iTHRIVE Plan at the recommendation of, and as part of your ongoing treatment with, a Cancer Center, in which case, the information will be conveyed to the Cancer Center."
  ...
  PROFILE_INTRO_1 = " The goal of the survey is to learn about your current lifestyle behaviors so that we can generate an iTHRIVE Plan that matches your unique strengths and areas of need. Based on all of your answers, your iTHRIVE Plan will present you with recommended Action Steps in five areas that are critical to optimal health: Diet, Movement, Environment, Rejuvenation and Spirit. As you take the survey, be sure to answer all of the questions as truthfully as possible so you will receive a perfectly tailored iTHRIVE Plan to best build your wellness!"
  ...
  SURVEY_FOOTER_TEXT = "If you are participating in the iTHRIVE Plan as a Patient of a Cancer Center, you recognize and agree that all information you submit may be disclosed to the Cancer Center."
